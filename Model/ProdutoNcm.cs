...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProdutoNcm :  IEquatable<ProdutoNcm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProdutoNcm" /> class.
        /// </summary>
        /// <param name="codigoNcm">codigoNcm.</param>
        /// <param name="descricaoNcm">descricaoNcm.</param>
        public ProdutoNcm(string codigoNcm = default(string), string descricaoNcm = default(string))
        {
        ...
        {
            return this.Equals(input as ProdutoNcm);
        }

        /// <summary>
        /// Returns true if ProdutoNcm instances are equal
        /// </summary>
        /// <param name="input">Instance of ProdutoNcm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProdutoNcm input)
        {
            if (input == null)
                return false;
