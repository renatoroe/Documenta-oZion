...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentoSaida :  IEquatable<DocumentoSaida>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentoSaida" /> class.
        /// </summary>
        ...
        /// <param name="documentoLiberadoEmbarque">documentoLiberadoEmbarque.</param>
        ...
        /// <param name="documentoOficialSaida">documentoOficialSaida.</param>
        /// <param name="dataEmissaoDocumentoOficial">dataEmissaoDocumentoOficial.</param>
        /// <param name="empresaEntrega">empresaEntrega.</param>
        /// <param name="idEnderecoEntrega">idEnderecoEntrega.</param>
        /// <param name="enderecoEntrega">enderecoEntrega.</param>
        /// <param name="volumeCubicoTotalEmb">volumeCubicoTotalEmb.</param>
        /// <param name="pesoLiquidoTotalEmb">pesoLiquidoTotalEmb.</param>
        public DocumentoSaida(long? codigoEstabelecimento = default(long?), string codigoEmpresa = default(string), string tipoDocumento = default(string), string serieDocumento = default(string), string documentoSaida = default(string), long? codigoDocumento = default(long?), string documentoRelacionado = default(string), EstadoDocumentoEnum? estadoDocumento = default(EstadoDocumentoEnum?), Empresa empresaEmitente = default(Empresa), Empresa empresaDestino = default(Empresa), NaturezaOperacao naturezaOperacao = default(NaturezaOperacao), DateTime? dataEmissao = default(DateTime?), DateTime? dataMovimento = default(DateTime?), string especieDocumento = default(string), string especieVolume = default(string), decimal? quantidadeVolume = default(decimal?), string numeroVolume = default(string), string marcaVolume = default(string), long? tipoFrete = default(long?), long? tipoConferencia = default(long?), string nfeChaveAcesso = default(string), string nfeProtocolo = default(string), string nfeDigestValue = default(string), DateTime? nfeDataRecebimento = default(DateTime?), NfeAmbiente nfeAmbiente = default(NfeAmbiente), NfeTipoEmissao nfeTipoEmissao = default(NfeTipoEmissao), NfeTipoImpressao nfeTipoImpressao = default(NfeTipoImpressao), FinalidadeDocumento finalidadeDocumento = default(FinalidadeDocumento), decimal? valorTotalDocumento = default(decimal?), decimal? valorIcms = default(decimal?), decimal? valorIcmsSub = default(decimal?), decimal? valorIpi = default(decimal?), decimal? valorFrete = default(decimal?), decimal? valorSeguro = default(decimal?), decimal? valorServico = default(decimal?), decimal? valorDesconto = default(decimal?), decimal? valorDescontoItem = default(decimal?), decimal? valorAcrescimo = default(decimal?), decimal? valorAcrescimoItem = default(decimal?), decimal? valorTotalProduto = default(decimal?), decimal? valorBaseIcms = default(decimal?), decimal? valorBaseIcmsSub = default(decimal?), decimal? valorBaseIpi = default(decimal?), decimal? pesoBruto = default(decimal?), decimal? pesoLiquido = default(decimal?), decimal? volumeCubico = default(decimal?), string informacaoAdicional1 = default(string), string informacaoAdicional2 = default(string), string informacaoAdicional3 = default(string), string cfop = default(string), string usuario = default(string), string usuarioGeracao = default(string), DateTime? dataHistorico = default(DateTime?), DateTime? dataGeracao = default(DateTime?), DateTime? dataAgendamento = default(DateTime?), string conhecimentoTransporte = default(string), long? idEnderecoEmpresa = default(long?), EnderecoEmpresa enderecoEmpresa = default(EnderecoEmpresa), string placaVeiculo = default(string), string ufVeiculo = default(string), string nomeMotorista = default(string), string documentoMotorista = default(string), bool? documentoLiberadoEmbarque = default(bool?), List<LoteSaida> loteSaida = default(List<LoteSaida>), EstadoDocumentoArquivoUploadEnum? estadoDocumentoArquivoUpload = default(EstadoDocumentoArquivoUploadEnum?), EstadoProcesso estadoProcesso = default(EstadoProcesso), string documentoQualidade = default(string), string observacaoDocumento = default(string), string documentoOficialSaida = default(string), DateTime? dataEmissaoDocumentoOficial = default(DateTime?), Empresa empresaEntrega = default(Empresa), long? idEnderecoEntrega = default(long?), EnderecoEmpresa enderecoEntrega = default(EnderecoEmpresa), decimal? volumeCubicoTotalEmb = default(decimal?), decimal? pesoLiquidoTotalEmb = default(decimal?))
        {
            // to ensure "naturezaOperacao" is required (not null)
            if (naturezaOperacao == null)
            {
                throw new InvalidDataException("naturezaOperacao is a required property for DocumentoSaida and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("especieDocumento is a required property for DocumentoSaida and cannot be null");
            }
            else
            {
            ...
            this._DocumentoSaida = documentoSaida;
            ...
            this.DocumentoLiberadoEmbarque = documentoLiberadoEmbarque;
            ...
            this.DocumentoOficialSaida = documentoOficialSaida;
            this.DataEmissaoDocumentoOficial = dataEmissaoDocumentoOficial;
            this.EmpresaEntrega = empresaEntrega;
            this.IdEnderecoEntrega = idEnderecoEntrega;
            this.EnderecoEntrega = enderecoEntrega;
            this.VolumeCubicoTotalEmb = volumeCubicoTotalEmb;
            this.PesoLiquidoTotalEmb = pesoLiquidoTotalEmb;
        }
        ...
        /// <summary>
        /// Gets or Sets _DocumentoSaida
        /// </summary>
        [DataMember(Name="documentoSaida", EmitDefaultValue=false)]
        public string _DocumentoSaida { get; set; }
        ...
        public long? TipoConferencia { get; set; }
        ...
        /// <summary>
        /// Gets or Sets DocumentoLiberadoEmbarque
        /// </summary>
        [DataMember(Name="documentoLiberadoEmbarque", EmitDefaultValue=false)]
        public bool? DocumentoLiberadoEmbarque { get; set; }

        /// <summary>
        /// Gets or Sets LoteSaida
        /// </summary>
        [DataMember(Name="loteSaida", EmitDefaultValue=false)]
        public List<LoteSaida> LoteSaida { get; set; }
        ...
        /// <summary>
        /// Gets or Sets DocumentoOficialSaida
        /// </summary>
        [DataMember(Name="documentoOficialSaida", EmitDefaultValue=false)]
        public string DocumentoOficialSaida { get; set; }

        /// <summary>
        /// Gets or Sets DataEmissaoDocumentoOficial
        /// </summary>
        [DataMember(Name="dataEmissaoDocumentoOficial", EmitDefaultValue=false)]
        public DateTime? DataEmissaoDocumentoOficial { get; set; }

        /// <summary>
        /// Gets or Sets EmpresaEntrega
        /// </summary>
        [DataMember(Name="empresaEntrega", EmitDefaultValue=false)]
        public Empresa EmpresaEntrega { get; set; }
        ...
        /// <summary>
        /// Gets or Sets EnderecoEntrega
        /// </summary>
        [DataMember(Name="enderecoEntrega", EmitDefaultValue=false)]
        public EnderecoEmpresa EnderecoEntrega { get; set; }

        /// <summary>
        /// Gets or Sets VolumeCubicoTotalEmb
        /// </summary>
        [DataMember(Name="volumeCubicoTotalEmb", EmitDefaultValue=false)]
        public decimal? VolumeCubicoTotalEmb { get; set; }

        /// <summary>
        /// Gets or Sets PesoLiquidoTotalEmb
        /// </summary>
        [DataMember(Name="pesoLiquidoTotalEmb", EmitDefaultValue=false)]
        public decimal? PesoLiquidoTotalEmb { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocumentoSaida {\n");
            ...
            sb.Append("  _DocumentoSaida: ").Append(_DocumentoSaida).Append("\n");
            ...
            sb.Append("  DocumentoLiberadoEmbarque: ").Append(DocumentoLiberadoEmbarque).Append("\n");
            sb.Append("  LoteSaida: ").Append(LoteSaida).Append("\n");
            ...
            sb.Append("  DocumentoOficialSaida: ").Append(DocumentoOficialSaida).Append("\n");
            sb.Append("  DataEmissaoDocumentoOficial: ").Append(DataEmissaoDocumentoOficial).Append("\n");
            sb.Append("  EmpresaEntrega: ").Append(EmpresaEntrega).Append("\n");
            sb.Append("  IdEnderecoEntrega: ").Append(IdEnderecoEntrega).Append("\n");
            sb.Append("  EnderecoEntrega: ").Append(EnderecoEntrega).Append("\n");
            sb.Append("  VolumeCubicoTotalEmb: ").Append(VolumeCubicoTotalEmb).Append("\n");
            sb.Append("  PesoLiquidoTotalEmb: ").Append(PesoLiquidoTotalEmb).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as DocumentoSaida);
        }

        /// <summary>
        /// Returns true if DocumentoSaida instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentoSaida to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentoSaida input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this._DocumentoSaida == input._DocumentoSaida ||
                    (this._DocumentoSaida != null &&
                    this._DocumentoSaida.Equals(input._DocumentoSaida))
                ) && 
                (
                ...
                (
                    this.DataAgendamento == input.DataAgendamento ||
                    (this.DataAgendamento != null &&
                    this.DataAgendamento.Equals(input.DataAgendamento))
                ) && 
                (
                ...
                (
                    this.DocumentoLiberadoEmbarque == input.DocumentoLiberadoEmbarque ||
                    (this.DocumentoLiberadoEmbarque != null &&
                    this.DocumentoLiberadoEmbarque.Equals(input.DocumentoLiberadoEmbarque))
                ) && 
                (
                    this.LoteSaida == input.LoteSaida ||
                    this.LoteSaida != null &&
                    this.LoteSaida.SequenceEqual(input.LoteSaida)
                ) && 
                (
                ...
                (
                    this.DocumentoOficialSaida == input.DocumentoOficialSaida ||
                    (this.DocumentoOficialSaida != null &&
                    this.DocumentoOficialSaida.Equals(input.DocumentoOficialSaida))
                ) && 
                (
                    this.DataEmissaoDocumentoOficial == input.DataEmissaoDocumentoOficial ||
                    (this.DataEmissaoDocumentoOficial != null &&
                    this.DataEmissaoDocumentoOficial.Equals(input.DataEmissaoDocumentoOficial))
                ) && 
                (
                    this.EmpresaEntrega == input.EmpresaEntrega ||
                    (this.EmpresaEntrega != null &&
                    this.EmpresaEntrega.Equals(input.EmpresaEntrega))
                ) && 
                (
                ...
                (
                    ...
                    this.EnderecoEntrega.Equals(input.EnderecoEntrega))
                ) && 
                (
                    this.VolumeCubicoTotalEmb == input.VolumeCubicoTotalEmb ||
                    (this.VolumeCubicoTotalEmb != null &&
                    this.VolumeCubicoTotalEmb.Equals(input.VolumeCubicoTotalEmb))
                ) && 
                (
                    this.PesoLiquidoTotalEmb == input.PesoLiquidoTotalEmb ||
                    (this.PesoLiquidoTotalEmb != null &&
                    this.PesoLiquidoTotalEmb.Equals(input.PesoLiquidoTotalEmb))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._DocumentoSaida != null)
                    hashCode = hashCode * 59 + this._DocumentoSaida.GetHashCode();
                ...
                if (this.DataAgendamento != null)
                    hashCode = hashCode * 59 + this.DataAgendamento.GetHashCode();
                ...
                if (this.DocumentoLiberadoEmbarque != null)
                    hashCode = hashCode * 59 + this.DocumentoLiberadoEmbarque.GetHashCode();
                if (this.LoteSaida != null)
                    hashCode = hashCode * 59 + this.LoteSaida.GetHashCode();
                ...
                if (this.DocumentoOficialSaida != null)
                    hashCode = hashCode * 59 + this.DocumentoOficialSaida.GetHashCode();
                if (this.DataEmissaoDocumentoOficial != null)
                    hashCode = hashCode * 59 + this.DataEmissaoDocumentoOficial.GetHashCode();
                if (this.EmpresaEntrega != null)
                    hashCode = hashCode * 59 + this.EmpresaEntrega.GetHashCode();
                if (this.IdEnderecoEntrega != null)
                    hashCode = hashCode * 59 + this.IdEnderecoEntrega.GetHashCode();
                if (this.EnderecoEntrega != null)
                    hashCode = hashCode * 59 + this.EnderecoEntrega.GetHashCode();
                if (this.VolumeCubicoTotalEmb != null)
                    hashCode = hashCode * 59 + this.VolumeCubicoTotalEmb.GetHashCode();
                if (this.PesoLiquidoTotalEmb != null)
                    hashCode = hashCode * 59 + this.PesoLiquidoTotalEmb.GetHashCode();
                return hashCode;
            }
        }
