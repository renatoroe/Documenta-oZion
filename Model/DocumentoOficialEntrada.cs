...
{
    /// <summary>
    /// DocumentoOficialEntrada
    /// </summary>
    [DataContract]
    public partial class DocumentoOficialEntrada :  IEquatable<DocumentoOficialEntrada>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentoOficialEntrada" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DocumentoOficialEntrada() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentoOficialEntrada" /> class.
        /// </summary>
        ...
        /// <param name="nfeEstado">nfeEstado.</param>
        /// <param name="tipoFrete">tipoFrete.</param>
        public DocumentoOficialEntrada(long? codigoEstabelecimento = default(long?), string codigoEmpresa = default(string), string tipoDocumento = default(string), string serieDocumento = default(string), string documentoOficialEntrada = default(string), long? codigoDocumento = default(long?), DateTime? dataEmissao = default(DateTime?), DateTime? dataMovimento = default(DateTime?), decimal? valorTotalDocumento = default(decimal?), decimal? valorTotalProduto = default(decimal?), decimal? valorBaseIcms = default(decimal?), decimal? valorIcms = default(decimal?), decimal? valorBaseIcmsSub = default(decimal?), decimal? valorIcmsSub = default(decimal?), decimal? valorBaseIpi = default(decimal?), decimal? valorIpi = default(decimal?), decimal? valorFrete = default(decimal?), decimal? valorSeguro = default(decimal?), decimal? valorDesconto = default(decimal?), decimal? valorAcrescimo = default(decimal?), long? integracao = default(long?), string especieDocumento = default(string), string cfop = default(string), NaturezaOperacao naturezaOperacao = default(NaturezaOperacao), string modeloDocumento = default(string), string documentoRelacionado = default(string), string observacaoDocumento = default(string), string especieVolume = default(string), decimal? quantidadeVolume = default(decimal?), string marcaVolume = default(string), string numeroVolume = default(string), string placaVeiculo = default(string), string ufVeiculo = default(string), string nomeMotorista = default(string), string documentoMotorista = default(string), decimal? pesoBruto = default(decimal?), decimal? pesoLiquido = default(decimal?), DateTime? dataPrevisaoMovimento = default(DateTime?), long? codigoDestino = default(long?), decimal? volumeCubico = default(decimal?), string conhecimentoTransporte = default(string), decimal? valorServico = default(decimal?), string usuario = default(string), DateTime? dataHistorico = default(DateTime?), string numeroSelo = default(string), long? idEnderecoEmpresa = default(long?), long? idEnderecoEntrega = default(long?), long? idEnderecoTransportadora = default(long?), string documentoQualidade = default(string), long? quantidadeItem = default(long?), long? sistemaModulo = default(long?), long? tipoFormulario = default(long?), decimal? valorAcrescimoItem = default(decimal?), decimal? valorDescontoItem = default(decimal?), long? mensagemFiscal = default(long?), Empresa empresaEmitente = default(Empresa), Empresa empresaDestino = default(Empresa), string codigoMatriz = default(string), string numeroDocumento = default(string), string cnpjCpfEmpresa = default(string), string ieRgEmpresa = default(string), string centroCusto = default(string), string codigoVendedor = default(string), string informacaoAdicional1 = default(string), string informacaoAdicional2 = default(string), string informacaoAdicional3 = default(string), string cnpjCpfEmitente = default(string), string ieRgEmitente = default(string), string numeroDocumentoFiscal = default(string), decimal? valorMinimo = default(decimal?), int? fatParcialOrdemSeparacao = default(int?), DateTime? dataVencimento = default(DateTime?), string usuarioGeracao = default(string), DateTime? dataGeracao = default(DateTime?), string nfeChaveAcesso = default(string), string nfeDigestValue = default(string), DateTime? nfeDataRecebimento = default(DateTime?), string nfeId = default(string), NfeAmbiente nfeAmbiente = default(NfeAmbiente), NfeTipoEmissao nfeTipoEmissao = default(NfeTipoEmissao), NfeTipoImpressao nfeTipoImpressao = default(NfeTipoImpressao), FinalidadeDocumento finalidadeDocumento = default(FinalidadeDocumento), long? enderecoProducao = default(long?), string descricaoDocumento = default(string), int? faturado = default(int?), string descricaoMensagemContribuinte = default(string), string nfeProtocolo = default(string), string stDocumentoAtualizacao = default(string), string nfeUfEmbarque = default(string), string nfeLocalEmbarque = default(string), string numeroRecopi = default(string), DateTime? nfeDataRegistroDpec = default(DateTime?), string nfeRegistroDpec = default(string), string nfeJustificativa = default(string), string nfeVersao = default(string), DateTime? nfeDataAutorizacao = default(DateTime?), string ieSubTributaria = default(string), DateTime? dataHoraEmissao = default(DateTime?), DateTime? dataHoraMovimento = default(DateTime?), int? nfeConsumidorFinal = default(int?), int? nfeIndicadorPresencial = default(int?), string nfeLocalDespacho = default(string), string arquivoEvento = default(string), int? nfeImprimir = default(int?), string nfeChaveAcessoReferencia = default(string), long? codigoGuiaTrafego = default(long?), EstadoDocumentoOficialEnum? estadoDocumentoOficial = default(EstadoDocumentoOficialEnum?), List<DocumentoOficialEntradaItem> documentoOficialEntradaItem = default(List<DocumentoOficialEntradaItem>), bool? permitirBaixa = default(bool?), bool? possuiAvaria = default(bool?), EstadoDocumentoArquivoUploadEnum? estadoDocumentoArquivoUpload = default(EstadoDocumentoArquivoUploadEnum?), long? nfeEstado = default(long?), long? tipoFrete = default(long?))
        {
            // to ensure "naturezaOperacao" is required (not null)
            if (naturezaOperacao == null)
            {
                throw new InvalidDataException("naturezaOperacao is a required property for DocumentoOficialEntrada and cannot be null");
            }
            else
            {
            ...
            this._DocumentoOficialEntrada = documentoOficialEntrada;
        ...
        /// <summary>
        /// Gets or Sets _DocumentoOficialEntrada
        /// </summary>
        [DataMember(Name="documentoOficialEntrada", EmitDefaultValue=false)]
        public string _DocumentoOficialEntrada { get; set; }
        ...
        /// <summary>
        /// Gets or Sets NfeEstado
        /// </summary>
        [DataMember(Name="nfeEstado", EmitDefaultValue=false)]
        public long? NfeEstado { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocumentoOficialEntrada {\n");
            ...
            sb.Append("  _DocumentoOficialEntrada: ").Append(_DocumentoOficialEntrada).Append("\n");
            ...
            sb.Append("  NfeEstado: ").Append(NfeEstado).Append("\n");
        ...
        {
            return this.Equals(input as DocumentoOficialEntrada);
        }

        /// <summary>
        /// Returns true if DocumentoOficialEntrada instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentoOficialEntrada to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentoOficialEntrada input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this._DocumentoOficialEntrada == input._DocumentoOficialEntrada ||
                    (this._DocumentoOficialEntrada != null &&
                    this._DocumentoOficialEntrada.Equals(input._DocumentoOficialEntrada))
                ) && 
                (
                ...
                (
                    this.NfeEstado == input.NfeEstado ||
                    (this.NfeEstado != null &&
                    this.NfeEstado.Equals(input.NfeEstado))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._DocumentoOficialEntrada != null)
                    hashCode = hashCode * 59 + this._DocumentoOficialEntrada.GetHashCode();
                ...
                if (this.NfeEstado != null)
                    hashCode = hashCode * 59 + this.NfeEstado.GetHashCode();
        ...
        {
            // EspecieDocumento (string) maxLength
            if(this.EspecieDocumento != null && this.EspecieDocumento.Length > 5)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for EspecieDocumento, length must be less than 5.", new [] { "EspecieDocumento" });
            }

            // EspecieDocumento (string) minLength
            if(this.EspecieDocumento != null && this.EspecieDocumento.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for EspecieDocumento, length must be greater than 0.", new [] { "EspecieDocumento" });
            }
            ...
            // ModeloDocumento (string) maxLength
            if(this.ModeloDocumento != null && this.ModeloDocumento.Length > 10)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ModeloDocumento, length must be less than 10.", new [] { "ModeloDocumento" });
            }

            // ModeloDocumento (string) minLength
            if(this.ModeloDocumento != null && this.ModeloDocumento.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ModeloDocumento, length must be greater than 0.", new [] { "ModeloDocumento" });
            }
            ...
            // ObservacaoDocumento (string) maxLength
            if(this.ObservacaoDocumento != null && this.ObservacaoDocumento.Length > 500)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ObservacaoDocumento, length must be less than 500.", new [] { "ObservacaoDocumento" });
            }

            // ObservacaoDocumento (string) minLength
            if(this.ObservacaoDocumento != null && this.ObservacaoDocumento.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ObservacaoDocumento, length must be greater than 0.", new [] { "ObservacaoDocumento" });
            }

            // EspecieVolume (string) maxLength
            if(this.EspecieVolume != null && this.EspecieVolume.Length > 10)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for EspecieVolume, length must be less than 10.", new [] { "EspecieVolume" });
            }

            // EspecieVolume (string) minLength
            if(this.EspecieVolume != null && this.EspecieVolume.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for EspecieVolume, length must be greater than 0.", new [] { "EspecieVolume" });
            }

            // MarcaVolume (string) maxLength
            if(this.MarcaVolume != null && this.MarcaVolume.Length > 30)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MarcaVolume, length must be less than 30.", new [] { "MarcaVolume" });
            }

            // MarcaVolume (string) minLength
            if(this.MarcaVolume != null && this.MarcaVolume.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MarcaVolume, length must be greater than 0.", new [] { "MarcaVolume" });
            }

            // NumeroVolume (string) maxLength
            if(this.NumeroVolume != null && this.NumeroVolume.Length > 10)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NumeroVolume, length must be less than 10.", new [] { "NumeroVolume" });
            }

            // NumeroVolume (string) minLength
            if(this.NumeroVolume != null && this.NumeroVolume.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NumeroVolume, length must be greater than 0.", new [] { "NumeroVolume" });
            }

            // PlacaVeiculo (string) maxLength
            if(this.PlacaVeiculo != null && this.PlacaVeiculo.Length > 7)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PlacaVeiculo, length must be less than 7.", new [] { "PlacaVeiculo" });
            }

            // PlacaVeiculo (string) minLength
            if(this.PlacaVeiculo != null && this.PlacaVeiculo.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PlacaVeiculo, length must be greater than 0.", new [] { "PlacaVeiculo" });
            }

            // UfVeiculo (string) maxLength
            if(this.UfVeiculo != null && this.UfVeiculo.Length > 2)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for UfVeiculo, length must be less than 2.", new [] { "UfVeiculo" });
            }

            // UfVeiculo (string) minLength
            if(this.UfVeiculo != null && this.UfVeiculo.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for UfVeiculo, length must be greater than 0.", new [] { "UfVeiculo" });
            }

            // NomeMotorista (string) maxLength
            if(this.NomeMotorista != null && this.NomeMotorista.Length > 40)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NomeMotorista, length must be less than 40.", new [] { "NomeMotorista" });
            }

            // NomeMotorista (string) minLength
            if(this.NomeMotorista != null && this.NomeMotorista.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NomeMotorista, length must be greater than 0.", new [] { "NomeMotorista" });
            }

            // DocumentoMotorista (string) maxLength
            if(this.DocumentoMotorista != null && this.DocumentoMotorista.Length > 20)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DocumentoMotorista, length must be less than 20.", new [] { "DocumentoMotorista" });
            }

            // DocumentoMotorista (string) minLength
            if(this.DocumentoMotorista != null && this.DocumentoMotorista.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DocumentoMotorista, length must be greater than 0.", new [] { "DocumentoMotorista" });
            }

            // ConhecimentoTransporte (string) maxLength
            if(this.ConhecimentoTransporte != null && this.ConhecimentoTransporte.Length > 10)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ConhecimentoTransporte, length must be less than 10.", new [] { "ConhecimentoTransporte" });
            }

            // ConhecimentoTransporte (string) minLength
            if(this.ConhecimentoTransporte != null && this.ConhecimentoTransporte.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ConhecimentoTransporte, length must be greater than 0.", new [] { "ConhecimentoTransporte" });
            }
            ...
            // NumeroSelo (string) maxLength
            if(this.NumeroSelo != null && this.NumeroSelo.Length > 10)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NumeroSelo, length must be less than 10.", new [] { "NumeroSelo" });
            }

            // NumeroSelo (string) minLength
            if(this.NumeroSelo != null && this.NumeroSelo.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NumeroSelo, length must be greater than 0.", new [] { "NumeroSelo" });
            }
            ...
            // CodigoMatriz (string) maxLength
            if(this.CodigoMatriz != null && this.CodigoMatriz.Length > 15)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CodigoMatriz, length must be less than 15.", new [] { "CodigoMatriz" });
            }

            // CodigoMatriz (string) minLength
            if(this.CodigoMatriz != null && this.CodigoMatriz.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CodigoMatriz, length must be greater than 0.", new [] { "CodigoMatriz" });
            }
            ...
            // CnpjCpfEmpresa (string) maxLength
            if(this.CnpjCpfEmpresa != null && this.CnpjCpfEmpresa.Length > 20)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CnpjCpfEmpresa, length must be less than 20.", new [] { "CnpjCpfEmpresa" });
            }

            // CnpjCpfEmpresa (string) minLength
            if(this.CnpjCpfEmpresa != null && this.CnpjCpfEmpresa.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CnpjCpfEmpresa, length must be greater than 0.", new [] { "CnpjCpfEmpresa" });
            }

            // IeRgEmpresa (string) maxLength
            if(this.IeRgEmpresa != null && this.IeRgEmpresa.Length > 20)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for IeRgEmpresa, length must be less than 20.", new [] { "IeRgEmpresa" });
            }

            // IeRgEmpresa (string) minLength
            if(this.IeRgEmpresa != null && this.IeRgEmpresa.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for IeRgEmpresa, length must be greater than 0.", new [] { "IeRgEmpresa" });
            }

            // CentroCusto (string) maxLength
            if(this.CentroCusto != null && this.CentroCusto.Length > 15)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CentroCusto, length must be less than 15.", new [] { "CentroCusto" });
            }

            // CentroCusto (string) minLength
            if(this.CentroCusto != null && this.CentroCusto.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CentroCusto, length must be greater than 0.", new [] { "CentroCusto" });
            }

            // CodigoVendedor (string) maxLength
            if(this.CodigoVendedor != null && this.CodigoVendedor.Length > 15)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CodigoVendedor, length must be less than 15.", new [] { "CodigoVendedor" });
            }

            // CodigoVendedor (string) minLength
            if(this.CodigoVendedor != null && this.CodigoVendedor.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CodigoVendedor, length must be greater than 0.", new [] { "CodigoVendedor" });
            }

            // InformacaoAdicional1 (string) maxLength
            if(this.InformacaoAdicional1 != null && this.InformacaoAdicional1.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for InformacaoAdicional1, length must be less than 50.", new [] { "InformacaoAdicional1" });
            }
            ...
            if(this.InformacaoAdicional2 != null && this.InformacaoAdicional2.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for InformacaoAdicional2, length must be less than 50.", new [] { "InformacaoAdicional2" });
            }
            ...
            if(this.InformacaoAdicional3 != null && this.InformacaoAdicional3.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for InformacaoAdicional3, length must be less than 50.", new [] { "InformacaoAdicional3" });
            }
            ...
            // CnpjCpfEmitente (string) maxLength
            if(this.CnpjCpfEmitente != null && this.CnpjCpfEmitente.Length > 20)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CnpjCpfEmitente, length must be less than 20.", new [] { "CnpjCpfEmitente" });
            }

            // CnpjCpfEmitente (string) minLength
            if(this.CnpjCpfEmitente != null && this.CnpjCpfEmitente.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CnpjCpfEmitente, length must be greater than 0.", new [] { "CnpjCpfEmitente" });
            }

            // IeRgEmitente (string) maxLength
            if(this.IeRgEmitente != null && this.IeRgEmitente.Length > 20)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for IeRgEmitente, length must be less than 20.", new [] { "IeRgEmitente" });
            }

            // IeRgEmitente (string) minLength
            if(this.IeRgEmitente != null && this.IeRgEmitente.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for IeRgEmitente, length must be greater than 0.", new [] { "IeRgEmitente" });
            }

            // NumeroDocumentoFiscal (string) maxLength
            if(this.NumeroDocumentoFiscal != null && this.NumeroDocumentoFiscal.Length > 10)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NumeroDocumentoFiscal, length must be less than 10.", new [] { "NumeroDocumentoFiscal" });
            }

            // NumeroDocumentoFiscal (string) minLength
            if(this.NumeroDocumentoFiscal != null && this.NumeroDocumentoFiscal.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NumeroDocumentoFiscal, length must be greater than 0.", new [] { "NumeroDocumentoFiscal" });
            }

            // NfeChaveAcesso (string) maxLength
            if(this.NfeChaveAcesso != null && this.NfeChaveAcesso.Length > 44)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeChaveAcesso, length must be less than 44.", new [] { "NfeChaveAcesso" });
            }

            // NfeChaveAcesso (string) minLength
            if(this.NfeChaveAcesso != null && this.NfeChaveAcesso.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeChaveAcesso, length must be greater than 0.", new [] { "NfeChaveAcesso" });
            }

            // NfeDigestValue (string) maxLength
            if(this.NfeDigestValue != null && this.NfeDigestValue.Length > 28)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeDigestValue, length must be less than 28.", new [] { "NfeDigestValue" });
            }

            // NfeDigestValue (string) minLength
            if(this.NfeDigestValue != null && this.NfeDigestValue.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeDigestValue, length must be greater than 0.", new [] { "NfeDigestValue" });
            }

            // NfeId (string) maxLength
            if(this.NfeId != null && this.NfeId.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeId, length must be less than 50.", new [] { "NfeId" });
            }

            // NfeId (string) minLength
            if(this.NfeId != null && this.NfeId.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeId, length must be greater than 0.", new [] { "NfeId" });
            }

            // DescricaoDocumento (string) maxLength
            if(this.DescricaoDocumento != null && this.DescricaoDocumento.Length > 100)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DescricaoDocumento, length must be less than 100.", new [] { "DescricaoDocumento" });
            }

            // DescricaoDocumento (string) minLength
            if(this.DescricaoDocumento != null && this.DescricaoDocumento.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DescricaoDocumento, length must be greater than 0.", new [] { "DescricaoDocumento" });
            }

            // DescricaoMensagemContribuinte (string) maxLength
            if(this.DescricaoMensagemContribuinte != null && this.DescricaoMensagemContribuinte.Length > 4000)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DescricaoMensagemContribuinte, length must be less than 4000.", new [] { "DescricaoMensagemContribuinte" });
            }

            // DescricaoMensagemContribuinte (string) minLength
            if(this.DescricaoMensagemContribuinte != null && this.DescricaoMensagemContribuinte.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DescricaoMensagemContribuinte, length must be greater than 0.", new [] { "DescricaoMensagemContribuinte" });
            }

            // NfeProtocolo (string) maxLength
            if(this.NfeProtocolo != null && this.NfeProtocolo.Length > 15)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeProtocolo, length must be less than 15.", new [] { "NfeProtocolo" });
            }

            // NfeProtocolo (string) minLength
            if(this.NfeProtocolo != null && this.NfeProtocolo.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeProtocolo, length must be greater than 0.", new [] { "NfeProtocolo" });
            }
            ...
            // NfeUfEmbarque (string) maxLength
            if(this.NfeUfEmbarque != null && this.NfeUfEmbarque.Length > 2)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeUfEmbarque, length must be less than 2.", new [] { "NfeUfEmbarque" });
            }

            // NfeUfEmbarque (string) minLength
            if(this.NfeUfEmbarque != null && this.NfeUfEmbarque.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeUfEmbarque, length must be greater than 0.", new [] { "NfeUfEmbarque" });
            }

            // NfeLocalEmbarque (string) maxLength
            if(this.NfeLocalEmbarque != null && this.NfeLocalEmbarque.Length > 60)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeLocalEmbarque, length must be less than 60.", new [] { "NfeLocalEmbarque" });
            }

            // NfeLocalEmbarque (string) minLength
            if(this.NfeLocalEmbarque != null && this.NfeLocalEmbarque.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeLocalEmbarque, length must be greater than 0.", new [] { "NfeLocalEmbarque" });
            }

            // NumeroRecopi (string) maxLength
            if(this.NumeroRecopi != null && this.NumeroRecopi.Length > 25)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NumeroRecopi, length must be less than 25.", new [] { "NumeroRecopi" });
            }

            // NumeroRecopi (string) minLength
            if(this.NumeroRecopi != null && this.NumeroRecopi.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NumeroRecopi, length must be greater than 0.", new [] { "NumeroRecopi" });
            }

            // NfeRegistroDpec (string) maxLength
            if(this.NfeRegistroDpec != null && this.NfeRegistroDpec.Length > 15)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeRegistroDpec, length must be less than 15.", new [] { "NfeRegistroDpec" });
            }

            // NfeRegistroDpec (string) minLength
            if(this.NfeRegistroDpec != null && this.NfeRegistroDpec.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeRegistroDpec, length must be greater than 0.", new [] { "NfeRegistroDpec" });
            }

            // NfeJustificativa (string) maxLength
            if(this.NfeJustificativa != null && this.NfeJustificativa.Length > 255)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeJustificativa, length must be less than 255.", new [] { "NfeJustificativa" });
            }

            // NfeJustificativa (string) minLength
            if(this.NfeJustificativa != null && this.NfeJustificativa.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeJustificativa, length must be greater than 0.", new [] { "NfeJustificativa" });
            }

            // NfeVersao (string) maxLength
            if(this.NfeVersao != null && this.NfeVersao.Length > 4)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeVersao, length must be less than 4.", new [] { "NfeVersao" });
            }

            // NfeVersao (string) minLength
            if(this.NfeVersao != null && this.NfeVersao.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeVersao, length must be greater than 0.", new [] { "NfeVersao" });
            }

            // IeSubTributaria (string) maxLength
            if(this.IeSubTributaria != null && this.IeSubTributaria.Length > 20)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for IeSubTributaria, length must be less than 20.", new [] { "IeSubTributaria" });
            }

            // IeSubTributaria (string) minLength
            if(this.IeSubTributaria != null && this.IeSubTributaria.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for IeSubTributaria, length must be greater than 0.", new [] { "IeSubTributaria" });
            }

            // NfeLocalDespacho (string) maxLength
            if(this.NfeLocalDespacho != null && this.NfeLocalDespacho.Length > 60)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeLocalDespacho, length must be less than 60.", new [] { "NfeLocalDespacho" });
            }

            // NfeLocalDespacho (string) minLength
            if(this.NfeLocalDespacho != null && this.NfeLocalDespacho.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeLocalDespacho, length must be greater than 0.", new [] { "NfeLocalDespacho" });
            }

            // ArquivoEvento (string) maxLength
            if(this.ArquivoEvento != null && this.ArquivoEvento.Length > 200)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ArquivoEvento, length must be less than 200.", new [] { "ArquivoEvento" });
            }

            // ArquivoEvento (string) minLength
            if(this.ArquivoEvento != null && this.ArquivoEvento.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ArquivoEvento, length must be greater than 0.", new [] { "ArquivoEvento" });
            }

            // NfeChaveAcessoReferencia (string) maxLength
            if(this.NfeChaveAcessoReferencia != null && this.NfeChaveAcessoReferencia.Length > 44)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeChaveAcessoReferencia, length must be less than 44.", new [] { "NfeChaveAcessoReferencia" });
            }

            // NfeChaveAcessoReferencia (string) minLength
            if(this.NfeChaveAcessoReferencia != null && this.NfeChaveAcessoReferencia.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NfeChaveAcessoReferencia, length must be greater than 0.", new [] { "NfeChaveAcessoReferencia" });
            }
