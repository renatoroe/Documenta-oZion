...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentoEntradaDTO :  IEquatable<DocumentoEntradaDTO>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentoEntradaDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DocumentoEntradaDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentoEntradaDTO" /> class.
        /// </summary>
        /// <param name="codigoEstabelecimento">codigoEstabelecimento (required).</param>
        /// <param name="codigoEmpresa">codigoEmpresa (required).</param>
        /// <param name="tipoDocumento">tipoDocumento (required).</param>
        /// <param name="serieDocumento">serieDocumento (required).</param>
        ...
        /// <param name="depositante">depositante (required).</param>
        ...
        public DocumentoEntradaDTO(long? codigoEstabelecimento = default(long?), string codigoEmpresa = default(string), string tipoDocumento = default(string), string serieDocumento = default(string), string documentoEntrada = default(string), long? codigoDocumento = default(long?), string documentoRelacionado = default(string), EstabelecimentoDTO estabelecimento = default(EstabelecimentoDTO), EmpresaDTO depositante = default(EmpresaDTO), EmpresaDTO matriz = default(EmpresaDTO), EmpresaDTO empresaEmitente = default(EmpresaDTO), EmpresaDTO empresaDestino = default(EmpresaDTO), EmpresaDTO transportadora = default(EmpresaDTO), NaturezaOperacaoDTO naturezaOperacao = default(NaturezaOperacaoDTO), NfeAmbienteDTO nfeAmbiente = default(NfeAmbienteDTO), NfeTipoEmissaoDTO nfeTipoEmissao = default(NfeTipoEmissaoDTO), NfeTipoImpressaoDTO nfeTipoImpressao = default(NfeTipoImpressaoDTO), FinalidadeDocumentoDTO finalidadeDocumento = default(FinalidadeDocumentoDTO), EstadoProcessoDTO estadoProcesso = default(EstadoProcessoDTO), TabelaServicoDTO tabelaServico = default(TabelaServicoDTO), List<LoteEntradaDTO> lotes = default(List<LoteEntradaDTO>), EstadoDocumentoEnum? estadoDocumento = default(EstadoDocumentoEnum?), DateTime? dataEmissao = default(DateTime?), DateTime? dataMovimento = default(DateTime?), string especieDocumento = default(string), string especieVolume = default(string), decimal? quantidadeVolume = default(decimal?), string numeroVolume = default(string), string marcaVolume = default(string), long? tipoFrete = default(long?), TipoConferenciaEnum? tipoConferencia = default(TipoConferenciaEnum?), string nfeChaveAcesso = default(string), string nfeProtocolo = default(string), string nfeDigestValue = default(string), DateTime? nfeDataRecebimento = default(DateTime?), decimal? valorTotalDocumento = default(decimal?), decimal? valorIcms = default(decimal?), decimal? valorIcmsSub = default(decimal?), decimal? valorIpi = default(decimal?), decimal? valorFrete = default(decimal?), decimal? valorSeguro = default(decimal?), decimal? valorServico = default(decimal?), decimal? valorDesconto = default(decimal?), decimal? valorDescontoItem = default(decimal?), decimal? valorAcrescimo = default(decimal?), decimal? valorAcrescimoItem = default(decimal?), decimal? valorTotalProduto = default(decimal?), decimal? valorBaseIcms = default(decimal?), decimal? valorBaseIcmsSub = default(decimal?), decimal? valorBaseIpi = default(decimal?), decimal? pesoBruto = default(decimal?), decimal? pesoLiquido = default(decimal?), decimal? volumeCubico = default(decimal?), string informacaoAdicional1 = default(string), string informacaoAdicional2 = default(string), string informacaoAdicional3 = default(string), string cfop = default(string), string usuario = default(string), string usuarioGeracao = default(string), DateTime? dataHistorico = default(DateTime?), DateTime? dataGeracao = default(DateTime?), string conhecimentoTransporte = default(string), long? idEnderecoEmpresa = default(long?), string placaVeiculo = default(string), string ufVeiculo = default(string), string nomeMotorista = default(string), string documentoMotorista = default(string), bool? docBloqueadoOficializacao = default(bool?), bool? possuiAvaria = default(bool?), EstadoDocumentoArquivoUploadEnum? estadoDocumentoArquivoUpload = default(EstadoDocumentoArquivoUploadEnum?), long? codigoTabelaServico = default(long?), string documentoOficialEntrada = default(string), string observacaoDocumento = default(string))
        {
            ...
            {
                throw new InvalidDataException("codigoEmpresa is a required property for DocumentoEntradaDTO and cannot be null");
            }
            else
            {
                this.CodigoEmpresa = codigoEmpresa;
            }
            // to ensure "tipoDocumento" is required (not null)
            if (tipoDocumento == null)
            {
                throw new InvalidDataException("tipoDocumento is a required property for DocumentoEntradaDTO and cannot be null");
            }
            else
            {
                this.TipoDocumento = tipoDocumento;
            }
            // to ensure "serieDocumento" is required (not null)
            if (serieDocumento == null)
            {
                throw new InvalidDataException("serieDocumento is a required property for DocumentoEntradaDTO and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("documentoEntrada is a required property for DocumentoEntradaDTO and cannot be null");
            }
            else
            {
                this.DocumentoEntrada = documentoEntrada;
            }
            // to ensure "depositante" is required (not null)
            if (depositante == null)
            {
                throw new InvalidDataException("depositante is a required property for DocumentoEntradaDTO and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("naturezaOperacao is a required property for DocumentoEntradaDTO and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("especieDocumento is a required property for DocumentoEntradaDTO and cannot be null");
            }
            else
            {
        ...
        public EstadoProcessoDTO EstadoProcesso { get; set; }

        /// <summary>
        /// Gets or Sets TabelaServico
        /// </summary>
        [DataMember(Name="tabelaServico", EmitDefaultValue=false)]
        public TabelaServicoDTO TabelaServico { get; set; }

        /// <summary>
        /// Gets or Sets Lotes
        /// </summary>
        [DataMember(Name="lotes", EmitDefaultValue=false)]
        public List<LoteEntradaDTO> Lotes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocumentoEntradaDTO {\n");
        ...
        {
            return this.Equals(input as DocumentoEntradaDTO);
        }

        /// <summary>
        /// Returns true if DocumentoEntradaDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentoEntradaDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentoEntradaDTO input)
        {
            if (input == null)
                return false;
