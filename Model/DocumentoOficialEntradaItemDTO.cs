...
{
    /// <summary>
    /// DocumentoOficialEntradaItemDTO
    /// </summary>
    [DataContract]
    public partial class DocumentoOficialEntradaItemDTO :  IEquatable<DocumentoOficialEntradaItemDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentoOficialEntradaItemDTO" /> class.
        /// </summary>
        ...
        public DocumentoOficialEntradaDTO DoctoOficialEntrada { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocumentoOficialEntradaItemDTO {\n");
        ...
        {
            return this.Equals(input as DocumentoOficialEntradaItemDTO);
        }

        /// <summary>
        /// Returns true if DocumentoOficialEntradaItemDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentoOficialEntradaItemDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentoOficialEntradaItemDTO input)
        {
            if (input == null)
                return false;
