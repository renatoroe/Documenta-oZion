...
{
    /// <summary>
    /// ProdutoSaldoInicialDTO
    /// </summary>
    [DataContract]
    public partial class ProdutoSaldoInicialDTO :  IEquatable<ProdutoSaldoInicialDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProdutoSaldoInicialDTO" /> class.
        /// </summary>
        ...
        public ProdutoSaldoInicialDTO(long? codigoEstabelecimento = default(long?), string codigoDepositante = default(string), string codigoProduto = default(string), string tipoUc = default(string), decimal? fatorTipoUc = default(decimal?), string classeProduto = default(string), decimal? quantidade = default(decimal?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProdutoSaldoInicialDTO {\n");
        ...
        {
            return this.Equals(input as ProdutoSaldoInicialDTO);
        }

        /// <summary>
        /// Returns true if ProdutoSaldoInicialDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of ProdutoSaldoInicialDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProdutoSaldoInicialDTO input)
        {
            if (input == null)
                return false;
