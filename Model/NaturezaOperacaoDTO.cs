...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NaturezaOperacaoDTO :  IEquatable<NaturezaOperacaoDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NaturezaOperacaoDTO" /> class.
        /// </summary>
        ...
        public NaturezaOperacaoDTO(string naturezaOperacao = default(string), string descricaoNaturezaOperacao = default(string), string naturezaOperacaoImpressao = default(string), string cfop1 = default(string), string cfop2 = default(string), string cfop3 = default(string), string usuario = default(string), DateTime? dataHistorico = default(DateTime?), string entradaSaida = default(string), string tipoEmitenteFiscal = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NaturezaOperacaoDTO {\n");
        ...
        {
            return this.Equals(input as NaturezaOperacaoDTO);
        }

        /// <summary>
        /// Returns true if NaturezaOperacaoDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of NaturezaOperacaoDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NaturezaOperacaoDTO input)
        {
            if (input == null)
                return false;
