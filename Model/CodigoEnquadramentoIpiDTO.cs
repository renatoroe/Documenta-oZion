...
{
    /// <summary>
    /// CodigoEnquadramentoIpiDTO
    /// </summary>
    [DataContract]
    public partial class CodigoEnquadramentoIpiDTO :  IEquatable<CodigoEnquadramentoIpiDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CodigoEnquadramentoIpiDTO" /> class.
        /// </summary>
        /// <param name="codigoEnquadramentoIpi">codigoEnquadramentoIpi.</param>
        public CodigoEnquadramentoIpiDTO(string codigoEnquadramentoIpi = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CodigoEnquadramentoIpiDTO {\n");
        ...
        {
            return this.Equals(input as CodigoEnquadramentoIpiDTO);
        }

        /// <summary>
        /// Returns true if CodigoEnquadramentoIpiDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of CodigoEnquadramentoIpiDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CodigoEnquadramentoIpiDTO input)
        {
            if (input == null)
                return false;
